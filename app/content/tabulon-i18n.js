...
const DICT = {
    en: {
        ...
        'install.credits': 'Fairy-Stockfish and Scan are separate projects, by their own authors, both under the GNU GPL v3. Tabulon only tells you where to put them. Their source code:',
        ...
        'play.fairyFallbackUnsupported': 'The multi-threaded engine is not available in this environment.',
    ...
    fr: {
        ...
        'install.credits': "Fairy-Stockfish et Scan sont des projets distincts, dus à leurs auteurs, tous deux sous licence GNU GPL v3. Tabulon se contente d'indiquer où les poser. Leur code source :",
        ...
        'play.fairyFallbackUnsupported': 'Le moteur multi-thread n’est pas disponible dans cet environnement.',
