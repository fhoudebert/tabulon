...
const DICT = {
    ...
    fr: {
        ...
        'load.samplesHelp': 'Les exemples ne sont pas intégrés à l’application : ils sont lus dans un dossier problems placé à côté de l’exécutable (ou à côté du dist externe). Un sous-dossier par jeu — son nom doit être le nom du jeu Jocly, par exemple classic-chess — et un onglet par sous-dossier. Déposez-y vos fichiers .pjn, .pgn ou .json, éventuellement accompagnés d’une image <nom>-thumb.jpg, et ils apparaissent ici. Essayez-en un pour chercher vous-même, utilisez Résoudre pour dérouler les coups, ou enregistrez-le pour vous en servir de point de départ.',
