...
const DICT = {
    en: {
        ...
        'problem.fromPosition': 'starts from a given position',
        'problem.gameN': 'Game {n}',
        'problem.solutionFile': 'Saved game for {game}: {plies} move(s), position and moves together. No commentary in this format.',
        'problem.unreadable': 'No game could be read from this file.',
        'problem.notFound': 'This example is no longer available — reopen it from the load screen.',
    ...
    fr: {
        ...
        'load.samplesHelp': 'Les exemples ne sont pas intégrés à l’application : ils sont lus dans un dossier problems placé à côté de l’exécutable (ou à côté du dist externe). Un sous-dossier par jeu — son nom doit être le nom du jeu Jocly, par exemple classic-chess — et un onglet par sous-dossier. Déposez-y vos fichiers .pjn, .pgn ou .json, éventuellement accompagnés d’une image <nom>-thumb.jpg, et ils apparaissent ici. Lancez-en un pour voir ce qu’il fait, ou enregistrez-le pour vous en servir de point de départ.',
        ...
        'problem.fromPosition': 'part d’une position donnée',
        'problem.gameN': 'Partie {n}',
        'problem.solutionFile': 'Partie enregistrée pour {game} : {plies} coup(s), position et coups ensemble. Ce format ne porte pas de commentaire.',
        'problem.unreadable': 'Aucune partie n’a pu être lue dans ce fichier.',
        'problem.notFound': 'Cet exemple n’est plus disponible — rouvrez-le depuis l’écran de chargement.',
