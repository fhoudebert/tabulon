...
const DICT = {
    en: {
        ...
        'install.releases': 'Downloads (jocly2 releases)',
    ...
    fr: {
        ...
        'nav.install': 'Installation',
        'install.title': 'Installation',
        'install.intro': "Tabulon fonctionne seul, mais on peut installer une ludothèque complète, des moteurs de jeu et des réseaux de neurones à côté de l'exécutable.",
        ...
        'install.releases': 'Téléchargements (versions de jocly2)',
        ...
        'install.scan.what': 'Le moteur de dames, utilisé par le niveau Expert des variantes de dames.',
        'install.nnue': 'Réseau de neurones (facultatif)',
        'install.nnue.what': "Un fichier .nnue renforce le moteur sur la variante dont son nom porte le préfixe. Facultatif.",
