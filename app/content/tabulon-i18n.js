...
const DICT = {
    en: {
        ...
        'load.samplesIntro': 'Play one to see what it does, or save it to keep as a starting point of your own.',
        'load.play': 'Play',
        'load.save': 'Save',
    ...
    fr: {
        ...
        'load.intro': 'permet d’ouvrir',
        'load.kind.book': 'Un livre',
        'load.kind.bookText': 'un fichier réunissant plusieurs parties, listées dans une fenêtre où vous pouvez choisi laquelle ouvrir — elles peuvent même relever de jeux différents.',
        ...
        'load.samplesIntro': 'Lancez-en un pour voir ce qu’il fait, ou enregistrez-le pour vous en servir de point de départ.',
        'load.play': 'Lancer',
